...
public class SensorInterface {
    ...
    private final static int[] icons = {
            R.drawable.unknown_sensor,
            R.drawable.accelerometer_sensor,
            R.drawable.magnetic_sensor,
            R.drawable.orientation_sensor,
            R.drawable.gyroscope_sensor,
            R.drawable.light_sensor,
            R.drawable.pressure_sensor,
            R.drawable.temp_sensor,
            R.drawable.proximity_sensor,
            R.drawable.gravity_sensor,
            R.drawable.linear_acceleration_sensor,
    ...
    public SensorInterface(Sensor s)
    {
