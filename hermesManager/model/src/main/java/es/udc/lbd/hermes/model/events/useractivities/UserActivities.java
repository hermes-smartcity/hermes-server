package es.udc.lbd.hermes.model.events.useractivities;
...
@Entity
@SequenceGenerator(name = "xeradorId", sequenceName = "useractivities_id_seq")
...
public class UserActivities implements Serializable{
	...
	public UserActivities(Long id, String eventId, Calendar endTime,
