...
@Repository
public class UserHeartRatesDaoImpl extends GenericDaoHibernate<UserHeartRates, Long> implements UserHeartRatesDao{
	...
	public long contar(){
		return (Long) getSession()
				.createQuery("select count(*) from UserHeartRates")
				.uniqueResult();
	}
	...
	public Long contarUserHeartRates(Long idUsuario, Calendar fechaIni, Calendar fechaFin){
		...
		String queryStr =  "select count(*) from UserHeartRates where 1 = 1 ";
		if(idUsuario!=null)
	...
	public List<UserHeartRatesDTO> obterUserHeartRatesWithLimit(Long idUsuario, Calendar fechaIni, 
		...
		List<UserHeartRatesDTO> elementos = null;
		...
		query.addScalar("bpm", FloatType.INSTANCE);
		...
		query.setResultTransformer(Transformers.aliasToBean(UserHeartRatesDTO.class));
	...
	public List<UserHeartRates> obterUserHeartRates(Long idUsuario, Calendar fechaIni,
		...
		List<UserHeartRates> elementos = null;

		String queryStr =  "from UserHeartRates d where 1=1 ";
		if(idUsuario!=null)
	...
	public void delete(Long idUsuario, Calendar starttime){
		String queryStr =  "DELETE from UserHeartRates WHERE usuarioMovil.id = :idUsuario ";
