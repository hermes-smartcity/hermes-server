...
@Repository
public class UserSleepDaoImpl extends GenericDaoHibernate<UserSleep, Long> implements UserSleepDao{
	...
	public long contar(){
		return (Long) getSession()
				.createQuery("select count(*) from UserSleep")
				.uniqueResult();
	}
	...
	public Long contarUserSleep(Long idUsuario, Calendar fechaIni, Calendar fechaFin){
		...
		String queryStr =  "select count(*) from UserSleep where 1 = 1 ";
		if(idUsuario!=null)
	...
	public List<UserSleepDTO> obterUserSleepWithLimit(Long idUsuario, Calendar fechaIni, 
		...
		List<UserSleepDTO> elementos = null;
	...
	public List<UserSleep> obterUserSleep(Long idUsuario, Calendar fechaIni,
		...
		List<UserSleep> elementos = null;

		String queryStr =  "from UserSleep d where 1=1 ";
		if(idUsuario!=null)
	...
	public void delete(Long idUsuario, Calendar starttime){
		String queryStr =  "DELETE from UserSleep WHERE usuarioMovil.id = :idUsuario ";
