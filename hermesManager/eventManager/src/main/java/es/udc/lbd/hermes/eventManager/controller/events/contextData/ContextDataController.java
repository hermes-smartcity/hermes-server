...
public class ContextDataController extends MainResource {
	...
	static Logger logger = Logger.getLogger(ContextDataController.class);

	@Autowired private ContextDataService contextDataServicio;

	@Autowired private UsuarioWebService usuarioWebService;


	@RequestMapping(value="/json/contextData", method = RequestMethod.GET)
	public ListaContextData getContextData(@RequestParam(value = "idUsuario", required = false) Long idUsuario,		
		...
		return contextDataServicio.obterContextData(idUsuario, ini, fin,
